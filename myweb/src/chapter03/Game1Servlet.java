...
public class Game1Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (client.size() >=3) {
			dest=request.getRequestDispatcher("/my/chapter03/gameEx1Done.jsp");
...
//			out.println("<h1>종료되었습니다</h1>");
			...
			if (ran.remove(num)) {
				client.add(num);
				dest=request.getRequestDispatcher("/my/chapter03/gameEx1Won.jsp");
//				response.sendRedirect("/my/chapter03/gameEx1Won.jsp");
//				response.sendRedirect("/my/chapter03/gameEx1Won.jsp");
//				out.println("<h1>당첨 되었습니다!!</h1>");
			} else {
				dest=request.getRequestDispatcher("/my/chapter03/gameEx1Fail.jsp");
//				response.sendRedirect("/my/chapter03/gameEx1Fail.jsp");
