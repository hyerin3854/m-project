<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
        ...
        Cookie cookie1= new Cookie("path1",
        		URLEncoder.encode("경로:/my/chapter09/path1","utf-8"));
        cookie1.setPath("/my/chapter09/path1");
        ...
        Cookie cookie4 = new Cookie("path4",
        		URLEncoder.encode("경로:/my/chapter09/path2" ,"utf-8"));
        cookie4.setPath("/my/chapter09/path2");
