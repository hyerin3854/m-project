...
public class ReplyRepo {
	...
	public boolean addReply(Reply reply) {
		String sql = "INSERT INTO reply" + "(body,memberid,boardId) " + "VALUES (?, ?, ?) ";
	...
	public List<Reply> listReply(String id) {
		...
		String sql = "SELECT id, body, memberid, " + "   boardid, inserted " + "   FROM reply" + " WHERE boardid=?"
				+ " ORDER BY id DESC";
		try (Connection con = DBCP.getConnection(); PreparedStatement stmt = con.prepareStatement(sql);
	...
	public void deleteReply(String replyId, String memberId) {
		String sql = "DELETE FROM reply " + "WHERE id=? " + "AND memberid=? ";
		try (Connection con = DBCP.getConnection(); PreparedStatement stmt = con.prepareStatement(sql)
	...
	public void updateReply(String replyId, String memberId, String body) {
		String sql = "UPDATE reply " + "SET body=? " + "WHERE id=? " + "AND  memberid=? ";
		try (
